...
#ifndef ECOMSDK_SWIFT_H
#define ECOMSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EcomSdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC7EcomSdk17BaseUIPreferences")
@interface BaseUIPreferences : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@class EcomUIPreferences;
enum SEnvironment : NSInteger;
@class EcomError;
@class SBankInvoiceIdPaymentRequest;
enum SPayState : NSInteger;

SWIFT_CLASS("_TtC7EcomSdk4Ecom")
@interface Ecom : NSObject
/// Ключ Kлиента для работы с сервисами платежного шлюза через SDK.
+ (void)setupWithUiPreferences:(EcomUIPreferences * _Nullable)uiPreferences environment:(enum SEnvironment)environment completion:(void (^ _Nullable)(EcomError * _Nullable))completion;
/// Единый метод для оплаты
+ (void)payWithBankInvoiceIdWithPaymentRequest:(SBankInvoiceIdPaymentRequest * _Nonnull)paymentRequest completion:(void (^ _Nonnull)(enum SPayState))completion;
...
SWIFT_CLASS("_TtC7EcomSdk9EcomError")
@interface EcomError : NSObject
...
SWIFT_CLASS("_TtC7EcomSdk27EcomUIBackgroundPreferences")
@interface EcomUIBackgroundPreferences : BaseUIPreferences
@end


SWIFT_CLASS("_TtC7EcomSdk23EcomUIButtonPreferences")
@interface EcomUIButtonPreferences : BaseUIPreferences
@end


SWIFT_CLASS("_TtC7EcomSdk17EcomUIPreferences")
@interface EcomUIPreferences : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7EcomSdk24EncDataRequestParameters")
@interface EncDataRequestParameters : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, PaymentSystem, open) {
  PaymentSystemMir = 0,
  PaymentSystemVisa = 1,
  PaymentSystemMc = 2,
  PaymentSystemAll = 3,
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC7EcomSdk9SBPButton")
